...
export default function Header (){
  ...
  return (
    <>
      <header className="max-[600]:grid max-[600]:grid-cols-2 flex justify-between fixed w-full z-2 p-4 bg-[#555555]/70 mb-5">
        ...
        <ul
          className={isMenu ? menuClass : "hidden md:flex justify-around gap-4"}
        >
          <li
            onClick={() => {
              router.push("./");
